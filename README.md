...
- [x] API surface (`GET /health`, `POST /predict`, `GET /tickets`)
...
- [ ] Schema: contacts, messages; **ticket detail/PATCH** endpoints; operations beyond `POST /predict` and `GET /tickets`
...
- Security & deployment (technical MVP baseline) → `docs/security-and-deployment.md`
...
- MVP checklists (technical / functional / final product) → **[Checklists](#smartticket-mvp-checklists) in this README**
